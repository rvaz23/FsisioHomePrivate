...
class TrainingsAdapter(val exercises: List<Trainings>, val listener: OnItemClickListener): RecyclerView.Adapter<TrainingsAdapter.MyViewHolder>() {

    //private var items:List<Exercises> = ArrayList()

    inner class MyViewHolder  (itemView: View) : RecyclerView.ViewHolder(itemView),View.OnClickListener{

        val training = itemView.findViewById(R.id.text_type) as TextView
